...
@Component({
  ...
  templateUrl: './lead-fallow-up.component.html',
  styleUrl: './lead-fallow-up.component.scss'
})
export class LeadFallowUpComponent {
  // breadCrumbItems: any;
  isFirstOpen = true
  ...
  ngOnInit(): void {
    ...
    this.leadservice.getPicklist().subscribe((data: any) => {
      ...
      this.data = data;
        ...
        this.LeadStatus = this.data.filter((item: any) => item.businessCode == "chits" && item.enumCode == "FollowupStatus");
