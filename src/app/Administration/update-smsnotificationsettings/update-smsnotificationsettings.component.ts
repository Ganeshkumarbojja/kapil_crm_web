...
@Component({
  selector: 'app-update-smsnotificationsettings',
  standalone: true,
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './update-smsnotificationsettings.component.html',
  styleUrl: './update-smsnotificationsettings.component.scss'
})
export class UpdateSmsnotificationsettingsComponent implements OnInit{
  editContentForm:any;
  GupshupsContent: any;
  id: any;
  updateUserForm: any;
  ...
  onSubmit() {
    ...
    this.notificationService.updateNotificationSettings(this.id, this.editContentForm.value).subscribe((data: any) => {
