...
@Component({
  ...
  styleUrl: './update-notification-settings.component.scss'
})
export class UpdateNotificationSettingsComponent implements OnInit {
  editContentForm:any;
  GupshupsContent: any;
  id: any;
  updateUserForm: any;
  ...
  getWhatsappIndividualData() {
    ...
    this.notificationService.getSmsNotificationsettingsById(this.id).subscribe((data: any) => {
  ...
  onSubmit() {
    ...
    this.notificationService.updateSMSNotificationSettings(this.id, this.editContentForm.value).subscribe((data: any) => {
