...
@Component({
  selector: 'app-employee-administrator',
  standalone: true,
  imports: [CommonModule , FormsModule, ReactiveFormsModule, OrderByPipe, MatDialogModule, NgxPaginationModule, PaginationModule],
  templateUrl: './employee-administrator.component.html',
  styleUrl: './employee-administrator.component.scss'
})
export class EmployeeAdministratorComponent {
  public display = "none";
  ...
  ngOnInit(): void {
    ...
    // this.userService.getAdministrator()subscribe((data: any) => {
    //   console.log(data);
    //   this.Userlist1 = data;
