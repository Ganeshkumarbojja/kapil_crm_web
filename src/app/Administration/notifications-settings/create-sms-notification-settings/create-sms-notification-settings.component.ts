...
@Component({
  selector: 'app-create-sms-notification-settings',
  standalone: true,
  imports: [CommonModule , FormsModule, ReactiveFormsModule],
  templateUrl: './create-sms-notification-settings.component.html',
  styleUrl: './create-sms-notification-settings.component.scss'
})
export class CreateSmsNotificationSettingsComponent implements OnInit{
  ...
  onSubmit() {
    ...
    this.notificationService.createSmsNotificationSetting(this.createNotificationForm.value).subscribe((data: any) => {
