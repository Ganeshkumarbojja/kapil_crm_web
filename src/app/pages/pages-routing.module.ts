...
import { ChitsComponent } from '../chits/agent-products/chits/chits.component';

const routes: Routes = [
  {path:'',component:ChitsComponent},
  {
    path: 'abc', loadChildren: () => import('./dashboards/dashboards.module').then(m => m.DashboardsModule)
  },
  {
