...
@Component({
  selector: 'app-apartments-edit-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './apartments-edit-lead.component.html',
  styleUrl: './apartments-edit-lead.component.scss'
})
export class ApartmentsEditLeadComponent {
