...
@Component({
  ...
  templateUrl: './apartments-leads.component.html',
  styleUrl: './apartments-leads.component.scss'
})
export class ApartmentsLeadsComponent {
  ...
  ngOnInit(): void {
    ...
    this.leadservice.getApartment().subscribe((data: any) => {
  ...
  openModal() {
    // this.display = "block";
    this.router.navigate(['/real-estate/apartments-create-leads']);
  ...
  openDialog(id: any) {
    ...
    this.router.navigate(['/real-estate/apartments-edit-leads', id])
