...
@Component({
  selector: 'app-apartments-create-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './apartments-create-lead.component.html',
  styleUrl: './apartments-create-lead.component.scss'
})
export class ApartmentsCreateLeadComponent {
  ...
  onSubmit() {
    ...
    this.leadservice.createLead(this.realestateLeadForm.value).subscribe(
      (res: any) => {
        ...
        // Success message
        this.showSuccess();
        this.router.navigate(['/real-estate/apartments-leads']);
      },
      (error) => {
        this.showError();
      }
