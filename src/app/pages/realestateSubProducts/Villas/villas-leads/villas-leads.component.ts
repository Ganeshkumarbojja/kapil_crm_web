...
@Component({
  ...
  templateUrl: './villas-leads.component.html',
  styleUrl: './villas-leads.component.scss'
})
export class VillasLeadsComponent implements OnInit {
  ...
  openModal() {
    this.router.navigate(['/real-estate/villas-create-leads']);
  }
