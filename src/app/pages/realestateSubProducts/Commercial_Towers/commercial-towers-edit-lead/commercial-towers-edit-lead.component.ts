...
@Component({
  selector: 'app-commercial-towers-edit-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './commercial-towers-edit-lead.component.html',
  styleUrl: './commercial-towers-edit-lead.component.scss'
})
export class CommercialTowersEditLeadComponent {
