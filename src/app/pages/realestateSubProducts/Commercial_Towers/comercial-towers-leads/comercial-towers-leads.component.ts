...
@Component({
  selector: 'app-comercial-towers-leads',
  standalone: true,
  ...
  templateUrl: './comercial-towers-leads.component.html',
  styleUrl: './comercial-towers-leads.component.scss'
})
export class ComercialTowersLeadsComponent {
  ...
  openModal() {
    // this.display = "block";
    this.router.navigate(['/real-estate/commercial-towers-create-lead']);
  ...
  openDialog(id: any) {
    ...
    this.router.navigate(['/real-estate/commercial-towers-edit-lead',id])
