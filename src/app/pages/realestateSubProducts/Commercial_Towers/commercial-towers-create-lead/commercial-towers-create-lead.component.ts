...
@Component({
  selector: 'app-commercial-towers-create-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './commercial-towers-create-lead.component.html',
  styleUrl: './commercial-towers-create-lead.component.scss'
})
export class CommercialTowersCreateLeadComponent {
  ...
  onSubmit() {
    ...
    this.leadservice.createLead(this.realestateLeadForm.value).subscribe(
      (res: any) => {
        ...
        // Success message
        this.showSuccess();
        this.router.navigate(['/real-estate/commercial-towers-lead']);
      },
      (error) => {
        this.showError();
      }
