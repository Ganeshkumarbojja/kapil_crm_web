...
@Component({
  selector: 'app-commercial-space-edit-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './commercial-space-edit-lead.component.html',
  styleUrl: './commercial-space-edit-lead.component.scss'
})
export class CommercialSpaceEditLeadComponent {
