...
@Component({
  selector: 'app-comercial-space-leads',
  standalone: true,
  ...
  templateUrl: './comercial-space-leads.component.html',
  styleUrl: './comercial-space-leads.component.scss'
})
export class ComercialSpaceLeadsComponent {
...
this.rolePermission = localStorage.getItem('rolepermissionjson');
  ...
  openModal() {
    // this.display = "block";
    this.router.navigate(['/real-estate/commercial-space-creat-lead']);
  ...
  openDialog(id: any) {
    ...
    this.router.navigate(['/real-estate/commercial-space-edit-lead', id])
