...
@Component({
  selector: 'app-open-plots-edit-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './open-plots-edit-lead.component.html',
  styleUrl: './open-plots-edit-lead.component.scss'
})
export class OpenPlotsEditLeadComponent {
