...
@Component({
  selector: 'app-units-edit-lead',
  standalone: true,
  imports: [TabsModule, FormsModule, ReactiveFormsModule, CommonModule],
  templateUrl: './units-edit-lead.component.html',
  styleUrl: './units-edit-lead.component.scss'
})
export class UnitsEditLeadComponent implements OnInit {
