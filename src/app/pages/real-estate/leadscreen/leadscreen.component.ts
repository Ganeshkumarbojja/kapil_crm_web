...
@Component({
  ...
  templateUrl: './leadscreen.component.html',
  styleUrl: './leadscreen.component.scss'
})
export class LeadscreenComponent {
  ...
  openModal() {
    // this.display = "block";
    this.router.navigate(['/real-estate/Addlead']);
  ...
  openDialog(id: any) {
    ...
    this.router.navigate(['/real-estate/EditLead', id])
