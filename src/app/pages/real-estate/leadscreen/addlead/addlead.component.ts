...
export class AddleadComponent {
  ...
  verticalData: any;
  data: any;
  facingenumConstants: any;
  villaTypeenumConstants: any;
  productsType: any;
  productsTypeenumConstants: any;
  ...
  ngOnInit() {
    ...
    this.leadservice.getPicklist().subscribe((data: any) => {
      ...
      this.productFacing = data.filter((item: any) => item.enumCode === "PropertyFacing");
      this.villaType = data.filter((item: any) => item.enumCode === "VillaType");
      this.productsType = data.filter((item: any) => item.enumCode === "PropertyType")
      this.LeadStatus = data.filter((item: any) => item.enumCode === "LeadStatus")
      console.log("this.verticalData", this.verticalData);
      console.log("this.productFacing", this.productFacing)
      //  
      this.LeadStatus = this.data.filter((item: any) => item.businessCode == "real-estate" && item.enumCode == "LeadStatus");
      ...
      if (this.productsType.length > 0) {
        this.productsTypeenumConstants = this.productsType[0].enumConstants;
        console.log("facingenumConstants", this.productsTypeenumConstants);

      }
      if (this.productFacing.length > 0) {
        this.facingenumConstants = this.productFacing[0].enumConstants;
        console.log("facingenumConstants", this.facingenumConstants);

      }
      if (this.villaType.length > 0) {
        this.villaTypeenumConstants = this.villaType[0].enumConstants;
        console.log("facingenumConstants", this.villaTypeenumConstants);
