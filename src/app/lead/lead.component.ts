...
import { UsersService } from '../chits/Services/users.service';
...
export class LeadComponent {
  ...
  //   getSelectedData() {
  //     if (this.selectedLabel === 'Chits' ) {
  //         return this.showChitsLeadData ? this.chitsLeadData : [];
  //     } else if (this.selectedLabel === 'Real Estate') {
  //         return this.realEstateLeadData || [];
  //     } else if (this.selectedLabel === 'Administration') {
  //         return this.adminLeadData || [];
  //     } else {
  //         return []; // Return an empty array if none of the conditions are met
  //     }
  // }
  collapse(id: any) {
  ...
  assignlead() {
    this.router.navigate(['/chits/assign-lead']);
  }

  leadTransfer() {
    this.router.navigate(['/chits/lead-transfer']);
  }
